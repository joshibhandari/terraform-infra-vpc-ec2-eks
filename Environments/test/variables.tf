...
variable "private_subnet_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "private_subnet_test"
  "env" = "test"}
}
...
variable "private_sg" {
  ...
  type        = string
  default =  "private_sg_test"
}

variable "public_sg" {
  description = "Name of the public security group"
  type        = string
  default = "public_sg_test"
}
