...
variable "nat_name" {
  ...
  type = string
  default = "eks_nat_test"
}

variable "eip_name" {
  description = "Name of the eip"
  type = string
  default = "eks_eip-test"
}
...
variable "private_route_table_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "private_rt_eks_test"
  "env" = "test"}
}
...
variable "public_route_table_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "public_rt_eks_test"
  "env" = "test"}
}
...
variable "private_subnet_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "private_subnet_eks_test"
  "env" = "test"}
}
...
variable "public_subnet_suffix" {
  ...
  type        = string
  default     = "public_subnet-eks_test"
}
...
variable "security_groups_name" {
  ...
  type        = string
  default     = "eks_test-security_group"
}
